<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
    <div class="sidenav-header mb-4">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            <img class="img-profile logo" src="{{ asset('img/logo.png') }}" style="width:100%;height:100%">
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'building-administration' || Route::currentRouteName() == 'add-task' ? 'active' : '' }}" href="{{ route('building-administration') }}">
                    <i class="fa fa-building-o" aria-hidden="true"></i>
                    <span class="nav-link-text ms-1">Building Administration</span>
                </a>
            </li>
            <li class="nav-item pb-2">
