            ...
            <div class="col-lg-12 mt-lg-0 mt-4">
                ...
                <div class="card mt-1" id="basic-info">
                    ...
                    <div class="card-body pt-0">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input id="firstName" name="firstName" class="form-control" type="text" placeholder="" required="required" onfocus="focused(this)" onfocusout="defocused(this)">
                                </div>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="card-body d-sm-flex mt-4 float-end">
                            <div class="d-flex align-items-center mb-sm-0 mb-4">

                            </div>

                            <a class="btn bg-gradient-dark mb-0 " href="javascript:;"><i class="fas fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Save</a>
                        </div>
